...
- Environment: Workplace culture and high stress levels are underlying factors contributing to carelessness and lack of motivation.
<img width="2177" height="1331" alt="image" src="https://github.com/user-attachments/assets/f708eacb-de8a-4979-82fa-d54e085a46d5" />

## Recommendations
Based on the analysis using these tools, I recommend the following actions and measurement to improve our moving operations:
1. Enhance Staff Training: Implement training on customer service, communication, professional appearance, and personal hygiene to foster a positive customer experience.
2. Improve Scheduling: Refine scheduling to ensure timely arrivals and enhance efficiency.
3. Regular Equipment Maintenance: Establish routine checks for equipment to ensure operational efficiency and minimize the risk of equipment failure.
4. Cultivate a Positive Workplace Culture: Promote accountability and provide Employee Assistance Programs (EAPs) to support employees' mental health in facing personal or work-related issues.
5. Implement a Feedback System: Create a structured feedback mechanism.
6. Establish an Alcohol Use Policy: Define acceptable behavior regarding alcohol consumption at work.

## Corporate Level Measurements
1. **Training Completion Rate:** Track the percentage of employees completing training within 3 months using management software. Aim for 90% completion.
2. **Customer Satisfaction Score (CSAT):** Conduct quarterly surveys to gather customer feedback, targeting an average score of 85% or higher.
3. **On-Time Arrival Rate:** Monitor the percentage of jobs completed on time via job tracking software, aiming for at least 95%.
4. **Job Completion Rate:** Assess the proportion of completed jobs versus those assigned, targeting a completion rate of 98%.
5. **Employee Satisfaction Survey:** Conduct annual surveys to gauge employee morale, aiming for an average score of 4.0 out of 5.
6. **Turnover Rate:** Calculate annual turnover by dividing the number of exits by the average workforce, aiming for less than 10%.

## Crew Level Measurements
1. **Equipment Downtime:** Track downtime as a percentage of operational hours, with a target of 5%.
2. **Maintenance Compliance Rate:** Monitoring compliance with scheduled maintenance tasks, aiming for 100% completion.
3. **Feedback Response Rate:** Measure the percentage of customer feedback responded within 24 hours, targeting a 95% response rate.
4. **Complaint Resolution Rate:** Assess the rate of complaints resolved within 48 hours, aiming for a resolution rate of 90%.
5. **Compliance Rate for Alcohol Use Policy:** Review adherence to the alcohol policy with random checks, aiming for 100% compliance.
6. **Incident Reports:** Track alcohol-related incident reports, aiming for zero incidents over the year.
